...
<div class="sidebar-collapse">
    <ul class="nav" id="side-menu">
        <li class="nav-header">
            <div class="dropdown profile-element" style="margin-top: -30px;"> <span>
                    <img alt="image" style="height: 80px;  width: 130px;" src="<?php echo base_url() ?>logo/<?php echo company_info()->logo; ?>" />
                </span>
