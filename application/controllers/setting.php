...
class Setting extends CI_Controller {
    ...
    function contribution_minimum() {
        ...
        $this->form_validation->set_rules('amount', lang('contribution_minimum_amount'), 'required|numeric');
        $this->form_validation->set_rules('charge', lang('contribution_minimum_overdueamount'), 'required|numeric');
    ...
    function saving_account_typecreate($id = null) {
        ...
        $this->form_validation->set_rules('account_description', lang('account_description'), 'required');
        $this->form_validation->set_rules('minimum_amount', lang('account_min_amount'), 'required|numeric');
        $this->form_validation->set_rules('monthly_amount', lang('account_charge'), 'required|numeric');
        if ($this->form_validation->run() == TRUE) {
            $account_info = array(
    ...
    function companyinfo_edit($id) {
        ...
        // $this->form_validation->set_rules('pre_phone', '', '');
        $this->form_validation->set_rules('companyname', lang('clientaccount_label_name'), 'required');
        $this->form_validation->set_rules('postaladdress', lang('clientaccount_label_postal_address'), '');
        $this->form_validation->set_rules('physicaladdress', lang('clientaccount_label_physical_address'), 'required');
        $this->form_validation->set_rules('phone', lang('clientaccount_label_phone'), 'required|valid_phone');
        $this->form_validation->set_rules('fax', lang('clientaccount_label_fax'), '');
        $this->form_validation->set_rules('email', lang('clientaccount_label_email'), 'required|valid_email');
    ...
    function share_setup() {
        ...
        $this->form_validation->set_rules('share_value', lang('share_current_value'), 'required|numeric');
        $this->form_validation->set_rules('share_minimum', lang('share_minimum'), 'required|integer');
        $this->form_validation->set_rules('share_maximum', lang('share_maximum'), 'required|integer');
